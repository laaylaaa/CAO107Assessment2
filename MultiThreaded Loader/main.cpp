...
std::vector<std::wstring> g_vecSoundFileNames; // hold all the images that have been loaded
...
void dummy(int ImageNo) {

	HBITMAP loadedImage = (HBITMAP)LoadImageW(NULL, g_vecImageFileNames[ImageNo].c_str(), IMAGE_BITMAP, 250, 250, LR_LOADFROMFILE);
